...
internal static class Native
{
    ...
    // Prevents DWM from running the minimize/restore transition for a
    // window. TinyShell owns the taskbar UI, so Explorer is not present to
    // provide Windows with a real taskbar-button animation target.
