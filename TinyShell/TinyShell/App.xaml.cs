...
public partial class App : Application
{
    ...
    private static bool _shellModeActive;
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        _shellModeActive = shellMode;

        if (shellMode)
        {
            ShellManager.KillExplorer();
            ShellManager.DisableMinimizeAnimation();
        }
    ...
    protected override void OnExit(ExitEventArgs e)
    {
        ...
        _desktop?.Close();
        Watcher?.Dispose();
        if (_shellModeActive) ShellManager.RestoreMinimizeAnimation();
